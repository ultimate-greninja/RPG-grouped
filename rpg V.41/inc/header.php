...
<!-- bootstrap -->
  ...
  <div class="container-fluid" >
    <a class="navbar-brand" href="character.php">
      <img src="img/base_character.png" style = "width:75px; height:140px;" alt="Logo" <?php if ($gender == "male"){echo 'id = "male_avatar_title"';}else if($gender == "female"){echo 'id = "female_avatar_title"';} else{echo 'id = "genderless"';}?> width="30" height="24">
    </a>
