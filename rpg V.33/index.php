...
<?php
  ...
  if (isset($_COOKIE["sellPrice"]) && isset($_COOKIE["weaponRarity"]) && isset($_COOKIE["weaponPower"]) && isset($_COOKIE["typeStore"]) && isset($_COOKIE["attackSpeed"]) && isset($_COOKIE["effect"]) && isset($_COOKIE["worthyness"]) && isset($_COOKIE["weaponDurability"]) && isset($_COOKIE["curse"])){
    ...
    $sqlAddWeapon = "INSERT INTO `weapon inventory` (userId, weaponName, weaponRarity, weaponType, weaponPower, attackSpeed, weaponDurability, effect, curse, worthyness, sellPrice) VALUES($userId, '$weaponName', '$weaponRarity', '$typeStore', $weaponPower, $attackSpeed, $weaponDurability, '$effect', '$curse', '$worthyness', $sellPrice)";
