...
<body>
    ...
    if (isset($_POST["btnRegister"])) {
        ...
        if ($existingUser) {
            ...
            $sql = "INSERT INTO user (username, email, passwordText, gender) VALUES('$username', '$email', '$password','$gender')";

            $result = mysqli_query($conn, $sql);

            $sql = "INSERT INTO weapon inventory (weaponName,weaponRarity,weaponType,weaponPower,attackSpeed,weaponDurability,effect,curse,worthyness,Sellprice) VALUES('Fists','common','fists',1,5,1000000000,none,none,worthy,0)";
