...
function Enemy(){
    ...
    if (enemyHealth <= 0){
        ...
        enemyType = EnemyType()
        enemyTypeid.innerHTML = enemyType

        enemyRace = EnemyRace()
        enemyRaceid.innerHTML = enemyRace
    }
...
function curseAndEffectUse(){
    ...
    if (E !== "none" || C !== "none"){
        ...
        if (E == "Poison" && PA == "false"){
            console.log("use stuff at bottom to make 'Poison'")
            PAid.innerHTML = `true`
        ...
        if (E == "Decay" && DA == "false"){
            console.log("use stuff at bottom to make 'Decay'")
            DAid.innerHTML = `true`
