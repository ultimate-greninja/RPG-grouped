...
<?php
  ...
  if (!isset($_COOKIE[$cookieName]) || empty($_COOKIE[$cookieName])) {
  ...
  else if (isset($COOKIE["maxUserHealth"]) && isset($COOKIE["userHealth"]) && isset($COOKIE["gold"]) && isset($COOKIE["userLv"]) && isset($COOKIE["exp"]) && isset($COOKIE["amountPulled"])){
    ...
    $result = mysqli_query($conn,$sql);
    $sql = "UPDATE user SET  = $ WHERE userId = $userId";
    $result = mysqli_query($conn,$sql);
    $sql = "UPDATE user SET  = $ WHERE userId = $userId";
    $result = mysqli_query($conn,$sql);
    $sql = "UPDATE user SET  = $ WHERE userId = $userId";
