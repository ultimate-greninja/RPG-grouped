...
function rarity(baseWeaponPower,baseWeaponDurability,weaponPullCost){
...
setTimeout(function hideFailMessage(){
  let fail = document.querySelector("#fail")
  fail.innerHTML = `<h1 hidden></h1>`
},1000)
...
function weaponRoll(){
    ...
    if (userGold >= weaponPullCost){
        ...
        let itemRarity = rarity(baseWeaponPower,baseWeaponDurability,weaponPullCost)
