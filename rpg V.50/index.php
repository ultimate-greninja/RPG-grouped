...
<?php
  ...
  if (isset($_COOKIE["enemyRace"]) && isset($_COOKIE["enemyAttackSpeed"]) && isset($_COOKIE["enemyAttack"]) && isset($_COOKIE["enemyHealth"]) && isset($_COOKIE["enemyMaxHealth"])){
    ...
    echo '<div class="progress" role="progressbar" aria-label="Danger example" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" id = "enemyHealthBar">
            <div class="progress-bar bg-danger" style="width:' . "$enemyHealthPercent" .'%">'. $enemyHealth .'/'. $enemyMaxHealth .'</div>
          </div>';
...
?>
  ...
  <!-- <div id = "buttons"> -->
  <div id = "weaponRoll">
    <button id = "weaponRollButton" onclick= "weaponRoll()" value="Weapon roll">Weapon Roll</button>
  </div>
  <div id = "armourRoll">
    <button id = "armourRollButton" onclick= "weaponRoll()"  value="Armour roll (WIP)">Armour Roll</button><!--onclick= "armourRoll()"-->
  </div>
  <div id = "swing">
    <button id = "swingButton" onclick= "swingPart1()" value="Swing">Swing</button>
  </div>
  <div id = "sell">
    <button id = "sellButton" onclick= "Sell()" value="Sell">Sell</button>
  </div>
  <div>
    <?php
      $userId = $_COOKIE["userId"];
      ...
      echo '<div class="progress" role="progressbar" aria-label="Danger example" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" id = "health">
              <div class="progress-bar bg-danger" style="width:' . "$healthPercent" .'%">'. $currentHealth .'/'. $maxHealth .'</div>
            </div>';
