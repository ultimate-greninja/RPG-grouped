...
function weaponRoll(userGold,userLv,amountPulled,exp){
    ...
    if (userGold >= weaponPullCost){
        ...
        if (itemRarity.fail == true){
            ...
            itemRarity = itemRarity.weaponRarity
            itemWeaponPower = itemType.weaponPower
            itemAttackSpeed = itemType.attackSpeed
            alwaysSpCheck = itemType.alwaysSpEffect
            itemType = itemType.weaponType
            weapon = {itemType,itemRarity}
            console.log(weapon)
