  ...
  <div>
    <?php
      ...
      if (isset($_COOKIE["sellPrice"]) && isset($_COOKIE["weaponRarity"]) && isset($_COOKIE["weaponPower"]) && isset($_COOKIE["typeStore"]) && isset($_COOKIE["attackSpeed"]) && isset($_COOKIE["effect"]) && isset($_COOKIE["worthyness"]) && isset($_COOKIE["weaponDurability"]) && isset($_COOKIE["curse"])){
        ...
        setcookie("weaponRaity","",time()-3600);
        setcookie("typeStore","",time()-3600);
        setcookie("weaponPower","",time()-3600);
        setcookie("attackSpeed","",time()-3600);
        setcookie("weaponDurability","",time()-3600);
        setcookie("effect","",time()-3600);
        setcookie("curse","",time()-3600);
        setcookie("worthyness","",time()-3600);
        setcookie("sellPrice","",time()-3600);
