class User{
    constructor(maxUserHealth,userHealth,gold,level,exp){
        this.maxUserHealth = maxUserHealth
    ...
    levelUp(){
        prevMaxHP = this.maxUserHealth
        console.log(prevMaxHP)
        this.maxUserHealth = this.maxUserHealth + 50
        console.log(prevMaxHP, this.maxUserHealth)
    }
}
class Enemy{
    constructor(enemyType,enemyMaxHelath,enemyCurrentHealth,enemyAttack,enemyAttackSpeed){
        this.enemyType = enemyType
        this.enemyMaxHelath = enemyMaxHelath
        this.enemyCurrentHealth = enemyCurrentHealth
        this.corpseGold = Math.ceil(enemyMaxHelath / 20)
...
let enemy = new Enemy()//add perameters
let user = new User(100,100,100,0,1,0)//add perameters maxUserHealth,userHealth,gold,level,exp
