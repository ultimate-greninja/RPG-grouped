<?php
    ...
    if ($page == 1 && $page !== $pageLimit){
        ...
        <form action = "<?php echo $_SERVER['PHP_SELF']?>" method = "GET">
            <button type = "submit" id = "forwardCenter" name = "next">NEXT</button>
        ...
        ?><form action = "<?php echo $_SERVER['PHP_SELF']?>" method = "GET">
            <button type = "submit" id = "backwardCenter" name = "back">BACK</button>
            <input type="hidden" name="page" value="<?php echo $page - 1; ?>">
        </form><?php
    }
    else{
        ?><form action = "<?php echo $_SERVER['PHP_SELF']?>" method = "GET">
            <button type = "submit" id = "backward" name = "back">BACK</button>
            <input type="hidden" name="page" value="<?php echo $page - 1; ?>">
        </form>
        <form action = "<?php echo $_SERVER['PHP_SELF']?>" method = "GET">
            <button type = "submit" id = "forward" name = "next">NEXT</button>
            <input type="hidden" name="page" value="<?php echo $page + 1; ?>">
        </form><?php
    }
?>
