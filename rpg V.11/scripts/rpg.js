    ...
    if (chance < 26){
        ...
        if (chance < 15){
            ...
            if (chance == 1){
                ...
                ER = "Dark Elf High Preistess"
            }
            else{
                ER = "Dark Elf Preist / Preistess error"
            }
        }
        else{
            ER = "Dark Elf"
...
function enemyAttack(){
    console.log("WIP (line 912)")
}
// re think whole thing do every so often then stop when enemy dies and have it go again with different stats
function enemyTurn(){
